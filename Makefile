...
#    Updated: 2021/08/21 00:50:36 by byahn            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES_BONUS = main_bonus.c check_map_bonus.c check_status_bonus.c check_status_enemy_bonus.c draw1_bonus.c draw2_bonus.c draw_enemy_bonus.c get_next_line_bonus.c move_player_bonus.c read_map_bonus.c utils_bonus.c
OBJECTS = $(SOURCES:%.c=%.o)
